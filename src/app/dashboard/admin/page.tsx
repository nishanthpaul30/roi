...
export default function AdminPage() {
  ...
  const handleDownloadTemplate = () => {
    const templateCsv = `AI Tool Flag,User Mail,Display Name,Activity Date,Month_Year,Month Id,Period Start Date,Period End Date,Token Consumption,Daily Billable Tokens,Cost in USD,Org Service Line,Org Sub Service Line,Country,Region,Management Region,Project Investment Code
copilot,john.doe@enterprise-corp.com,John Doe,2026-03-01,March_2026,202603,01/03/2026,31/03/2026,25000,25000,0.35,Consulting,Strategy,United States,North America,Americas,PRJ-CNS-1234
chatgpt,jane.smith@enterprise-corp.com,Jane Smith,2026-03-02,March_2026,202603,01/03/2026,31/03/2026,42000,42000,0.65,Technology,Data & AI,United Kingdom,Europe,EMEA,PRJ-TCH-5678
claude,alex.wong@enterprise-corp.com,Alex Wong,2026-03-03,March_2026,202603,01/03/2026,31/03/2026,18000,18000,0.28,Financial Services,Banking,Singapore,Southeast Asia,APAC,PRJ-FIN-9012`;
