// Importing this module pulls in RAW_CSV_DATA (a multi-MB embedded copy of the
// CSV). Client Components must go through /api/metrics/raw-rows instead — this
// guard turns an accidental client import into a build error rather than a
// silent multi-MB bundle regression.
import 'server-only';
